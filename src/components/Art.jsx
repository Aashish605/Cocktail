...
const Art = () => {
    ...
    useGSAP(() => {
        ...
        tl.to('.will-fade', { opacity: 0, stagger: 0.2, ease: 'power1.inOut' }).to('.masked-img', 
            ...
            <div className="container mx-auto h-full pt-20">
                ...
                <div className='masked-container'>
                    ...
                    <div className="masked-content">
                        ...
                        <p>This is a perfect blend of artistry and craftsmanship made with passion and care.</p>
                    </div>
                </div>
